...
public class AdapterSmsSampleData extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterSmsSampleData(Context ctx, ArrayList<Transaction> items, Listener listener) {
        this.ctx = ctx;
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sms_sample_data, parent, false);
        vh = new ViewHolder(v);
        return vh;
    }
